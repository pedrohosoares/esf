		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<!-- End Col -->
					<div class="col-md-12 col-lg-8 tabletMarginTop">
						<div class="row">
							<?php
	...
	if ( defined( 'FW' ) ) :
		...
		if ( $backto_top == 'yes' ) :
			...
			<div id="back-to-top" class="back-to-top">
				<button class="btn btn-dark" title="<?php esc_attr_e( 'Voltar para Topo', 'geobin' ) ?>">
...
<footer id="tw-footer" class="tw-footer footer-classic">
	...
	if ( defined( 'FW' ) ) :
		...
		if ( $backto_top == 'yes' ) :
			?>
			<div id="back-to-top" class="back-to-top">
				<button class="btn btn-dark" title="<?php esc_attr_e( 'Voltar para o Topo', 'geobin' ) ?>">
					<i class="fa fa-angle-up"></i>
				</button>
			</div>
			<?php
