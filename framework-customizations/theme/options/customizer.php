			...
			'header_top_settings'	 => array(
				...
				'options'	 => array(
					...
					'top_menu'					 => array(
						'type'			 => 'switch',
						'value'			 => 'yes',
						'label'			 => __( 'Show Top menu?', '{domain}' ),
						'desc'			 => __( 'If you would like to disable top menu set NO.', '{domain}' ),
						'left-choice'	 => array(
							'value'	 => 'yes',
							'label'	 => __( 'Yes', '{domain}' ),
						),
					...
					'geobin_main_logo_2'			 => array(
						'label'			 => esc_html__( 'Menu Logo 2', 'geobin' ),
						'type'			 => 'upload',
						'desc'			 => esc_html__( 'Upload the a logo with the dimention of 168 x 61', 'geobin' ),
						'images_only'	 => true,
						'files_ext'		 => array( 'jpg', 'png', 'jpeg', 'gif', 'svg' ),
			...
			'menu_styles'			 => array(
				...
				'options'	 => array(
					...
					'box_shadow'					 => array(
						'type'			 => 'switch',
						'value'			 => 'no',
						'label'			 => __( 'Remove bottom menu box shadow?', '{domain}' ),
						'desc'			 => __( 'Would you like to remove menu bottom box shadow ?', '{domain}' ),
						'left-choice'	 => array(
							'value'	 => 'yes',
							'label'	 => __( 'Yes', '{domain}' ),
						),
			...
			'footer_panel'			 => array(
				...
				'options'	 => array(
					...
					'footer_border_color'		 => array(
						...
						'type'	 => 'color-picker',
						'desc'	 => esc_html__('footer border color for footer style 2'),
