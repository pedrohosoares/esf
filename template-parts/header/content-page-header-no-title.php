...
if ( defined( 'FW' ) ) {
	...
	if ( $header_image == '' ) {
		$bg_image = $page_global_image != '' ? 'style="background-position: center;background-image: url(' . $page_global_image[ 'url' ] . ')"' : '';
	} else {
		$bg_image = $header_image != '' ? 'style="background-position: center;background-image: url(' . $header_image[ 'url' ] . ')"' : '';
	}
