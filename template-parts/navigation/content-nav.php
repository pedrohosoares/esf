...
if ( defined( 'FW' ) ) {
	...
	$geobin_main_logo_2	 = fw_get_db_customizer_option( 'geobin_main_logo_2' );
	...
	$main_logo_2			 = (isset( $geobin_main_logo_2[ 'url' ] ) && $geobin_main_logo_2[ 'url' ] != '' ? $geobin_main_logo_2[ 'url' ] : '');
				...
				<div class="tw-header">
					<div class="container">
						<nav class="navbar navbar-expand-lg navbar-light dark-nav nav-lite">
							<button class="navbar-toggler toogle-lite" type="button" style="top: -45px;" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
							aria-expanded="false" aria-label="Toggle navigation">
								<span class="navbar-toggler-icon"></span>
							</button>
						<!-- End of Navbar toggler -->
	...
	<?php } elseif ( $menu_style == 'menu-8' ) { ?>
		...
		<header class="<?php echo esc_attr( $menu_class ) ?>">
			<div class="container esconde">
				...
				<div class="tw-header">
					<div class="container">
						<img src="<?php echo esc_url( $main_logo_2 ); ?>" alt="<?php bloginfo( 'name' ); ?>" style="float: left;width: 100px;margin-top: 14px;" class="mostra">
						<nav class="navbar navbar-expand-lg navbar-light dark-nav nav-lite">
							<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent"
							aria-expanded="false" aria-label="Toggle navigation">
							<span class="navbar-toggler-icon"></span>
