...
if( $show_offcanvas['hr_offcanvas'] == 'yes' ) {
    ...
    <div class="search-bar">
        ...
        <form role="search" method="get" class="search-bar-fixed" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            <input type="search" id="<?php echo esc_attr($unique_id); ?>" placeholder="<?php echo esc_attr_x( 'Buscar &hellip;', 'placeholder', 'geobin' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
